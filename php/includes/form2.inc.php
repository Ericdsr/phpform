<form action="index.php" method="POST" class="col-md-9" enctype="multipart/form-data">
    ...
    <div class="mb-3" >
      ...
      <div class="mb-3" >
        ...
        <input type="number" class="form-control" min="18" max="70" name="age" required>
      </div>
      <div class="input-group" >
          <span class="input-group-text">Taille(1,26m à 3m)</span>
          <input type="number" class="form-control" step="0.01" min="1.26" max="3" name="taille" required>
